...
// v1/api/power but lacking payload
// grabbed direct from wireshark
const static uint8_t flawed_power_request[] =
{
    0x48, 0x01, 0x92, 0xee, // tkl(8)
    0xc5, 0xf0, 0x61, 0x8b, 0x5c, 0x45, 0x87, 0x8b, // token
    0xb2, 0x76, 0x31,   // "v1"
