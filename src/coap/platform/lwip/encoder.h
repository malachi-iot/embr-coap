...
struct StreambufEncoderImpl<::embr::lwip::basic_opbuf_streambuf<TChar> >
{
    typedef typename estd::remove_const<::embr::lwip::basic_opbuf_streambuf<TChar> >::type streambuf_type;
