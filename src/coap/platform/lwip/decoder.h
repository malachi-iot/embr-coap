...
StreambufDecoder<embr::lwip::legacy::ipbuf_streambuf> make_decoder(embr::lwip::PbufNetbuf* netbuf)
{
    ...
    return StreambufDecoder<embr::lwip::legacy::ipbuf_streambuf>(netbuf->pbuf());
}
