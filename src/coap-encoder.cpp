...
void ExperimentalPrototypeBlockingOptionEncoder1::option(pipeline::IPipelineWriter& writer, internal::option_number_t number, uint16_t length)
{
    uint8_t buffer[8];
...
void
ExperimentalPrototypeBlockingOptionEncoder1::option(pipeline::IPipelineWriter& writer, internal::option_number_t number, const pipeline::MemoryChunk& value)
{
...
bool ExperimentalPrototypeNonBlockingOptionEncoder1::option(pipeline::IBufferedPipelineWriter& writer,
                                                            internal::option_number_t number,
